...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    BOOL isLogin = [[NSUserDefaults standardUserDefaults] objectForKey:LoginStatus];
    BOOL isAtomicFingerLogin = [[NSUserDefaults standardUserDefaults] objectForKey:atomicFingerLogin];
    
    if (isLogin && isAtomicFingerLogin) {
        
        UINavigationController * navi = [[UINavigationController alloc]initWithRootViewController:[WGFingerViewController new]];
